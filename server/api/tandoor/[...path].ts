...
export default defineEventHandler(async (event) => {
  ...
  console.log('DEBUG: Server received request:', {
    method,
    path: pathParts,
    query,
    body
  ...
  console.log('DEBUG: Server forwarding request to Tandoor:', {
    url,
    method,
    headers: {
  ...
  try {
    ...
    console.log('DEBUG: Fixed URL:', fixedUrl)
    ...
    console.log('DEBUG: Tandoor API response:', response)
